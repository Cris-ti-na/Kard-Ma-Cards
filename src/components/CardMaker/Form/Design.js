          ...
          <div className="article__custom__ccolor">
            ...
            <fieldset className="article__custom__colors">
              <label className="article__custom__cgreen">
                <input type="radio" value="1" name="select-color" id="palette" defaultChecked onClick={this.handleColor} />
              ...
              <label className="article__custom__cred">
                <input type="radio" value="2" id="palette" name="select-color" onClick={this.handleColor} />
              ...
              <label className="article__custom__cmix">
                <input type="radio" value="3" id="palette" name="select-color" onClick={this.handleColor} />
